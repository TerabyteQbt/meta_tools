...
public class UploadPackDriver extends QbtCommand<UploadPackDriver.Options> {
    @QbtCommandName("uploadPackDriver")
    ...
    public int run(final OptionsResults<? extends Options> options) throws Exception {
        ...
        return PinProxyUtils.locked(root, () -> {
            ...
            ImmutableList<String> cmd = ImmutableList.<String>builder().add("git", "upload-pack").addAll(args).build();
